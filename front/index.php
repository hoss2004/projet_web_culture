...
// Appel à la méthode pour afficher les produits au front
                            ...
                            <div class="row custom-block mb-3">
                                <div class="col-lg-2 col-md-4 col-12 order-2 order-md-0 order-lg-0">
                                    <div class="custom-block-date-wrap d-flex d-lg-block d-md-block align-items-center mt-3 mt-lg-0 mt-md-0">
                                        <!-- Displaying a dummy date or you can adjust this to show the product's creation date -->
                                ...
                                <div class="col-lg-6 col-12 order-3 order-lg-0">
                                    <div class="custom-block-info mt-2 mt-lg-0">
                                        <a href="event-listing.php" class="events-title mb-3"><?= htmlspecialchars($product['nom']) ?></a>
                                        ...
                                        <div class="d-flex flex-wrap border-top mt-4 pt-3">
                                            ...
                                            <div class="mb-4 mb-lg-0">
                                                <div class="d-flex flex-wrap align-items-center mb-1">
                                                    <span class="custom-block-span">Category:</span>
                                                    <p class="mb-0"><?= htmlspecialchars($product['category_name']) ?></p>
                                                </div>
                                            </div>
<!-- HOTT PAGE -->
                                            <div class="d-flex align-items-center ms-lg-auto">
                                                <a href="event-detail.php" class="btn custom-btn">View Product</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="col-12">
                            <p class="text-center">No upcoming products at the moment.</p>
                        </div>
                    <?php endif; ?>
